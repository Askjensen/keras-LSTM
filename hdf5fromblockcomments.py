...
#filename = "DF/cleaned_posts.txt" #todo: change to blaa blok comments - cleaned text preferrrably....
filename = "../word2vec/Pol_comments_block.txt" #todo: change to blaa blok comments - cleaned text preferrrably....
...
filepath="weights-improvement_SUC-{epoch:02d}-{loss:.4f}-bigger.hdf5"
